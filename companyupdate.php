      ...
      <form name="myformcont" class="my-2" action="" method="POST">
        ...
        <input type="hidden" name="id" value="<?php echo $pid; ?>">
          ...
          <div class="col-sm-6 form-group">
            ...
            <input type="text" class="form-control" name="question" id="name-l" placeholder=" How Do You Knoe Him/Her"  value="<?php echo $details;?>" style="font-size:15px;"> 
          </div>   <div class="col-sm-6 form-group">
             <label for="passing year">Relationship With Employee</label>
            <input type="text" class="form-control" name="relationship" id="name-l" placeholder=" Reletionship with Employee"  value="<?php echo $relationships;?>" style="font-size:15px;"> 
          </div>   <div class="col-sm-6 form-group">
             <label for="passing year">Belongs To Department</label>
            <input type="text" class="form-control" name="department" id="name-l" placeholder=" Department name"  value="<?php echo $belongs_department;?>" style="font-size:15px;"> 
          </div>
