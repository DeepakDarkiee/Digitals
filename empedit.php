...
<div class="col-sm-6 form-group" style="margin-top: -20px;">
          ...
          <div class="col-sm-6 form-group">
            ...
            <input type="text" class="form-control" name="aadhar" id="name-f" placeholder=" Adhar Number" value="<?php echo $aadhar;?>" style="font-size:15px;">
          </div>
          <div class="col-sm-6 form-group">
            <label for="cost_center"> Pan Card</label>
            <input type="text" class="form-control" name="pan" id="cost_center" placeholder=" Pain Card Number"  value="<?php echo $pan;?>" style="font-size:15px;">
          </div>
      ...
      <div class="col-sm-6 form-group">
        ...
        <input type="text" class="form-control" name="fname" id="description" placeholder=" Father Name" value="<?php echo $fname;?>" style="font-size:15px;">
      </div>
      <div class="col-sm-6 form-group">
        <label for="pan_no"> Father Occoupation</label>
        <input type="text" class="form-control" name="occupation" id="pan-no" placeholder=" Father Occoupation " value="<?php echo $occupation;?>" style="font-size:15px;">
      </div>
      <div class="col-sm-6 form-group">
        <label for="created_on">Father Number</label>
        <input type="int" class="form-control" name="fnum" id="pan-no" placeholder=" Father Number"  value="<?php echo $fnum;?>" style="font-size:15px;">
      </div>
