         ...
         <h1 style="color:black;font-size:200%; text-align:center">since 30 days </h1>
          ...
          <div class="info-box "style="background-color:#fa7900;">
             ...
             $rs=readrecord($qry);
              ...
              echo '<h4 style="font-size:30px;text-align:center;"><i class="fas fa-user-tie" ></i>  '.$row3.' 
              </h4>';
       ?>
        <h1 style="color:black;font-size:200%; text-align:center" >Total Traine.</h1>
           </div>
           <!--/.info-box-->
         </div>
         <!--/.col-->
...
<div class="col-sm-6 form-group" style="margin-top: -20px;">
            ...
            <input type="email" class="form-control" name="email" id="name-l" placeholder=" Email"  style="font-size:15px;">
          </div>
         
          <div class="col-sm-6 form-group">
            <label for="phone_no">Phone No:</label>
            <input type="phone" name="phone" class="form-control" id="Date" placeholder=" Phone No."  style="font-size:15px;">
          </div>
          <div class="col-sm-6 form-group">
            <label for="aadhar card">Adhar no..</label>
            <input type="phone" class="form-control" name="aadhar_no" id="name-f" placeholder=" Adhar Number"  style="font-size:15px;">
          </div>
          <div class="col-sm-6 form-group">
            <label for="pan card"> Pan Card</label>
            <input type="text" class="form-control" name="pan_card" id="cost_center" placeholder=" Pain Card Number"  style="font-size:15px;">
          </div>
      ...
      <div class="col-sm-6 form-group">
        ...
        <select input type="text" class="form-control" name="gender" id="name-l" value="Gender" placeholder="Gender"  style="font-size:15px;">
      ...
      <div class="col-sm-6 form-group">
        ...
        <input type="Date" class="form-control" name="dob" id="name-l" placeholder="DOB"  style="font-size:15px;">
      </div>

      <div class="col-sm-6 form-group">
        <label for="bloodgroup"> Blood Group</label>
        <select input type="text" class="form-control" name="bloodgroup" id="address-1" placeholder=" Blood Group"  style="font-size:15px;">
      ...
      <div class="col-sm-6 form-group">
        ...
        <input type="text" class="form-control" name="fathername" id="description" placeholder=" Father Name"  style="font-size:15px;">
      </div>
      <div class="col-sm-6 form-group">
        <label for="father_occupation"> Father's Occupation</label>
        <input type="text" class="form-control" name="fatheroccu" id="pan-no" placeholder=" Father Occoupation "  style="font-size:15px;">
      </div>
      <div class="col-sm-6 form-group">
        <label for="father_no">Father's Number</label>
        <input type="phone" class="form-control" name="fatherno" id="pan-no" placeholder=" Father Number"  style="font-size:15px;">
      </div>
      
      <div class="col-sm-6 form-group">
        <label for="city">City</label>
        <input type="text" name="city" class="form-control datetimepicker" id="Date" placeholder=" City"  style="font-size:15px;">
      </div>

      <div class="col-sm-6 form-group">
        <label for="state">State</label>
        <input type="text" name="state"  class="form-control datetimepicker" id="Date" placeholder="State "  style="font-size:15px;">
      </div>
      <div class="col-sm-6 form-group">
        <label for="pincode">Pincode</label>
        <input type="phone" name="pincode"  class="form-control datetimepicker" id="Date" placeholder=" Pincode"  style="font-size:15px;">
      </div>
        <div class="col-sm-6 form-group">
        <label for="address">Address</label>
        <input type="text" name="address"  class="form-control datetimepicker" id="Date" placeholder=" Address"  style="font-size:15px;">
      </div>
      <div class="col-sm-6 form-group">
