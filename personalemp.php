...
<div class="col-sm-6 form-group" style="margin-top: -20px;">
          ...
          <div class="col-sm-6 form-group">
            ...
            <input type="text" class="form-control" name="aadhar" id="name-f" placeholder=" Adhar Number"  style="font-size:15px;">
          </div>
          <div class="col-sm-6 form-group">
            <label for="cost_center"> Pan Card</label>
            <input type="text" class="form-control" name="pan" id="cost_center" placeholder=" Pain Card Number"  style="font-size:15px;">
          </div>
      ...
      <div class="col-sm-6 form-group">
        ...
        <select input type="text" class="form-control" name="gender" id="name-l" placeholder="  Gender "  style="font-size:15px;">
      ...
      <div class="col-sm-6 form-group">
        <label for="cc description">Father's Name</label>
        <input type="text" class="form-control" name="fname" id="description" placeholder=" Father Name"  style="font-size:15px;">
      </div>
      <div class="col-sm-6 form-group">
        <label for="pan_no"> Father's Occupation</label>
        <input type="text" class="form-control" name="occupation" id="pan-no" placeholder=" Father Occoupation "  style="font-size:15px;">
      </div>
      <div class="col-sm-6 form-group">
        <label for="created_on">Father's Number</label>
        <input type="int" class="form-control" name="fnum" id="pan-no" placeholder=" Father Number"  style="font-size:15px;">
      </div>
      ...
      <div class="col-sm-6 form-group">
        ...
        <input type="text" name="pincode"  class="form-control datetimepicker" id="Date" placeholder=" Pincode"  style="font-size:15px;">
      </div>
        <div class="col-sm-6 form-group">
