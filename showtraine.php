...
$a="DS/TR/".$i;
  while($row=mysqli_fetch_array($rs))
  {
    ...
    <td><h1> <a href="trainedetail.php?Tid=<?php echo $row["Tid"];?>"> <?php echo $a;?></a></h1>
    </td>
  ...
  <form class="modal1-content" action="" method="POST">
    <div class="container">
      ...
      <div class="clearfix">
        ...
        <button type="button" onclick="document.getElementById('id01').style.display='none'" class="updatebtn"style="background-color: purple; color: white;height: 35px;width: 65px; border-radius:25px;"><a href="traine_update.php?Tid=<?php echo $row["Tid"];?>"><h1 style="color: white;">update</h1></a></button>
      </div>
      </div>
      <div class="col-md-3"></div>
    </div>
  ...
  <form class="modal1-content" action="" method="POST">
    <div class="container">
      ...
      <div class="clearfix">
        ...
        <button type="button" onclick="document.getElementById('id02').style.display='none'" class="deletebtn"style="background-color: purple;height: 35px;width: 65px; border-radius:25px;"><a href="traine_delete.php?Tid=<?php echo $row["Tid"];?>"><h1 style="color: white;">Delete</h1></a></button>
      </div>
        </div>
        <div class="col-md-4"></div>
      </div>
...
<button id="button_color" style="background-color:#1a2732; color:white; height: 40px; width: 100px; border-radius:25px;margin-left:10px;"><a href="particulartrainee.php?Tid=<?php echo $row["Tid"];?>" style="color:white;"><h1 style="color: white;">Attendance</h1></a></button>
<div id="id01" class="modal">
  <span onclick="document.getElementById('id01').style.display='none'" class="close" title="Close Modal">×</span>
  <form class="modal1-content" action="" method="POST">
  <div class="col-md-4">
